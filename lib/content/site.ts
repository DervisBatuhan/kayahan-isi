...
const tr: SiteContent = {
  ...
  stats: [
    ...
    { value: "8", suffix: " İlçe", label: "Aynı Gün Servis" },
  ...
  serviceFocus: {
    heroPrimary: { label: "Servis Talebi", href: "/tr/servis-talebi" },
    heroSecondary: { label: "Kurumsal Çözümler", href: "/tr/cozumler" },
    headerCta: { label: "Servis Çağır", href: "tel:+902124418888" },
    navBadge: "7/24",
    strip: {
      eyebrow: "SERVİS",
      title: "Kombi, klima ve şofben servisi — aynı gün.",
      text: "45 yıl DemirDöküm ve Vaillant yetkili servis deneyimiyle bugün tüm markalara hizmet veriyoruz. İstanbul Avrupa Yakası'nda sekiz ilçede arıza, bakım, orijinal parça ve montaj.",
      proofs: ["Aynı gün müdahale", "Tüm markalar", "Orijinal parça", "8 ilçe"],
      items: [
        { title: "Kombi Servisi", text: "Arıza, yıllık bakım, petek temizliği, yoğuşmalıya dönüşüm.", href: "/tr/kombi-servisi" },
        { title: "Klima Servisi", text: "Bakım, gaz dolumu, kaçak tespiti, montaj ve söküm-takım.", href: "/tr/klima-servisi" },
        { title: "Şofben Servisi", text: "Gazlı ve elektrikli modellerde arıza, bakım, mevzuata uygun montaj.", href: "/tr/sofben-servisi" },
      ],
    ...
    form: {
      ...
      lead: "Cihazınızı ve ilçenizi seçin, sizi en kısa sürede arayalım. Acil durumlar için 7/24 hattımız: 0212 441 88 88.",
      deviceLabel: "Cihaz",
      devices: ["Kombi", "Klima", "Şofben", "Diğer"],
      brandLabel: "Marka",
      brandPh: "DemirDöküm, Vaillant, Baymak…",
      districtLabel: "İlçe",
      districts: ["Bahçelievler", "Bakırköy", "Bağcılar", "Esenler", "Güngören", "Zeytinburnu", "Küçükçekmece", "Fatih", "Diğer"],
      timingLabel: "Ne zaman?",
      timings: ["Bugün", "Yarın", "Bu hafta", "Planlı bakım"],
      nameLabel: "Ad Soyad",
      phoneLabel: "Telefon",
      noteLabel: "Arıza açıklaması (isteğe bağlı)",
      notePh: "Örn. kombi F.28 hatası veriyor, petekler ısınmıyor…",
      submit: "Servis Talebi Gönder",
      sending: "Gönderiliyor…",
      okTitle: "Talebiniz alındı.",
      okText: "Mesai saatlerinde 30 dakika içinde arıyoruz. Acilse WhatsApp'tan hemen yazabilirsiniz.",
      okWhatsapp: "WhatsApp'tan yaz",
      sideTitle: "Neden Kayahan Isı servisi?",
      sidePoints: [
        "45 yıl DemirDöküm & Vaillant yetkili servis deneyimi",
        "Aynı gün müdahale — 8 ilçe, İstanbul Avrupa Yakası",
        "Orijinal parça, işçilik garantisi, yazılı servis raporu",
        "MYK belgeli teknisyen, ölçümlü bakım (baca gazı analizi)",
      ],
    },
  },
  footer: {
...
const en: SiteContent = {
  ...
  stats: [
    ...
    { value: "8", suffix: " Districts", label: "Same-Day Service" },
  ...
  serviceFocus: {
    heroPrimary: { label: "Request Service", href: "/en/servis-talebi" },
    heroSecondary: { label: "Corporate Solutions", href: "/en/cozumler" },
    headerCta: { label: "Call Service", href: "tel:+902124418888" },
    navBadge: "24/7",
    strip: {
      eyebrow: "SERVICE",
      title: "Boiler, AC and water-heater service — same day.",
      text: "With 45 years as DemirDöküm and Vaillant authorised service behind us, we now serve every brand: repair, maintenance, genuine parts and installation across eight districts on Istanbul's European side.",
      proofs: ["Same-day response", "All brands", "Genuine parts", "8 districts"],
      items: [
        { title: "Boiler Service", text: "Repair, annual maintenance, radiator flushing, condensing upgrade.", href: "/en/kombi-servisi" },
        { title: "AC Service", text: "Maintenance, refrigerant charge, leak detection, installation and relocation.", href: "/en/klima-servisi" },
        { title: "Water Heater Service", text: "Gas and electric models: repair, maintenance, code-compliant installation.", href: "/en/sofben-servisi" },
      ],
      phoneLabel: "Call now",
      whatsappLabel: "WhatsApp",
    ...
    form: {
      ...
      lead: "Pick your appliance and district and we will call you back shortly. Urgent? Our 24/7 line: +90 212 441 88 88.",
      deviceLabel: "Appliance",
      devices: ["Boiler", "Air conditioner", "Water heater", "Other"],
      brandLabel: "Brand",
      brandPh: "DemirDöküm, Vaillant, Baymak…",
      districtLabel: "District",
      districts: ["Bahçelievler", "Bakırköy", "Bağcılar", "Esenler", "Güngören", "Zeytinburnu", "Küçükçekmece", "Fatih", "Other"],
      timingLabel: "When?",
      timings: ["Today", "Tomorrow", "This week", "Planned maintenance"],
      nameLabel: "Full name",
      phoneLabel: "Phone",
      noteLabel: "Fault description (optional)",
      notePh: "e.g. boiler shows F.28, radiators stay cold…",
      submit: "Send Service Request",
      sending: "Sending…",
      okTitle: "Request received.",
      okText: "We call back within 30 minutes during working hours. If it is urgent, message us on WhatsApp right away.",
      okWhatsapp: "Message on WhatsApp",
      sideTitle: "Why Kayahan Isı service?",
      sidePoints: [
        "45 years of DemirDöküm & Vaillant authorised-service experience",
        "Same-day response — 8 districts, Istanbul European side",
        "Genuine parts, workmanship guarantee, written service report",
        "Certified technicians, measured maintenance (flue-gas analysis)",
      ],
    },
  },
  footer: {
