...
export const activityDefaults: Record<ActivityKind, ActivityContent> = {
  climate: {
    ...
    asset: "/assets/activity-climate-cgi.webp",
  ...
  heating: {
    ...
    asset: "/assets/activity-heating-cgi.webp",
  ...
  cooling: {
    ...
    asset: "/assets/activity-cooling-cgi.webp",
  ...
  insulation: {
    ...
    asset: "/assets/activity-insulation-cgi.webp",
  ...
  energy: {
    ...
    asset: "/assets/activity-energy-cgi.webp",
