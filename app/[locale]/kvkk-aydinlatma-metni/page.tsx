...
export async function generateMetadata({ params }: PageProps<"/[locale]/kvkk-aydinlatma-metni">): Promise<Metadata> {
  const { locale } = await params;
  return buildPortedMetadata(locale, "/kvkk-aydinlatma-metni");
}

export default async function Page({ params }: PageProps<"/[locale]/kvkk-aydinlatma-metni">) {
  const { locale } = await params;
